<?php
/**
 * Blocked attempt logger (Lite). Auto-prunes to DROPLOCK_LITE_LOG_CAP entries.
 *
...
class DropLock_Logger {
	...
	public function log( $args ) {
		...
		// Lite caps the log size — auto-prune.
		$this->prune_to_cap();
	}

	protected function prune_to_cap() {
		global $wpdb;
		$cap   = defined( 'DROPLOCK_LITE_LOG_CAP' ) ? (int) DROPLOCK_LITE_LOG_CAP : 50;
		$table = self::table_name();
